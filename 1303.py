"""
2 Start in XZ-plane.
3 z-axis: normal to surface.
4 Cross wind along y-axis.
5 dx(t)/dt = Vx(t)
6 dVx(t)/dt = Frv(V)*Vx/m
7 dy(t)/dt = Vy(t)
8 dVy(t)/dt = Fwind/m + Frv(V)*Vy/m
9 dz(t)/dt = Vz(t)
10 dVz(t)/dt = -g + Frv(V)*Vz/m
11 """
...
A = 0  # N*sec/m
B = 0  # N*sec^3/m^3
Fwind = 0.00  # N (force of cross wind along y-axis)
tm = 110.0  # sec
