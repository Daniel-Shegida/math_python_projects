...
Vx_min = round(Vx[tmax])
print("Vx_max=", Vx_max)
Vz_min = round(Vz[tmax])
print("Vz_max=", Vz_max)
print("tmax=", tmax)
...
x_y_res_painter(t, tmax, Vz, Vz_min, Vz_max, Vz, Vz_min, Vz_max, Vx, Vx_min, Vx_max, Vx, Vx_min, Vx_max, z, z, x, x)
