...
logfile = open('lab_8_shegida.py.txt', 'w')
...
V0 = 1000.0  # m/sec
res = module.xz_point(m,g,A,B, tm, nt, x0, z0,al, V0)
...
V0_start = 500.0
root = module.fSolveFun_opt([al_start, V0_start], xfin0, zfin0, m,g,A,B, tm, nt, x0, z0)
...
sol = module.odeintSystem(m,g, A, B, [x0, Vx0, z0, Vz0], t)
x = sol[:, 0]
Vx = sol[:, 1]
z = sol[:, 2]
Vz = sol[:, 3]
